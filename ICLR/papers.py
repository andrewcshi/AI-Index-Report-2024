...
def find_papers(file, transparency_keywords, fairness_keywords, privacy_keywords, security_keywords):
    ...
    with open(file, 'r') as iclr_file:
      ...
      papers = [a for a in papers if '/virtual/2020/poster' in a['href']]

    for paper in papers:
      title = paper.text.strip()
      title_lower = title.lower()
      link = 'https://iclr.cc' + paper['href']
      print(link)
...
### TESTING ###
# result = find_papers('iclrpapers20.html', transparency_keywords, fairness_keywords, privacy_keywords, security_keywords)
# print(result)