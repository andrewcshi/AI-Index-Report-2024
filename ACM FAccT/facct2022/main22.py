...
def main():
    ...
    papers_transparency = find_papers('faccthtml/facctpapers22.html', transparency_keywords)
    papers_fairness = find_papers('faccthtml/facctpapers22.html', fairness_keywords)
    papers_privacy = find_papers('faccthtml/facctpapers22.html', privacy_keywords)
    papers_security = find_papers('faccthtml/facctpapers22.html', security_keywords)
