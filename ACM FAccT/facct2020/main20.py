from papers20 import find_papers
...
def main():
    base_url = 'https://facctconference.org/2020/acceptedpapers'
    result = []
    ...
    papers_transparency = find_papers('faccthtml/facctpapers20.html', transparency_keywords)
    papers_fairness = find_papers('faccthtml/facctpapers20.html', fairness_keywords)
    papers_privacy = find_papers('faccthtml/facctpapers20.html', privacy_keywords)
    papers_security = find_papers('faccthtml/facctpapers20.html', security_keywords)
